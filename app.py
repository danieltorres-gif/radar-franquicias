...
st.sidebar.markdown("---")
# EL NUEVO INTERRUPTOR DE MAPA DE CALOR
mostrar_solo_calor = st.sidebar.checkbox("🔥 Ver solo Mapa de Calor (Ocultar locales)", value=False)
...
if boton_buscar:
    if not rubros_seleccionados:
        ...
        with st.spinner('Conectando a los satélites y descargando datos comerciales...'):
            ...
            # Capa de Pines (Se oculta si el CEO activó la casilla)
